...
# Label map
# Заменили названия классов на наши
voc_labels = ('bg', 'nine', 'ten', 'jack', 'queen', 'king', 'ace')
label_map = {
...
distinct_colors = ['#e6194b', '#3cb44b', '#ffe119', '#0082c8', '#f58231', '#911eb4', '#FFFFFF']
label_color_map = {k: distinct_colors[i] for i, k in enumerate(label_map.keys())}

# Добавим функцию для отрисовки лоса
...
# Добавим сюда функцию для получения лейбла
